...
Adapted from original cart pole gym environment to initialize pole facing down.
"""
...
class CartPoleEnv(gym.Env[np.ndarray, int | np.ndarray]):
    ...
    def __init__(
        ...
        self.action_space = spaces.Box(-self.force_mag, self.force_mag, shape=(), dtype=np.float64) # spaces.Discrete(2)
